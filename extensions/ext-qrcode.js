svgEditor.addExtension("QR code", function (S) {
    ...
    var updateText = function(elem, text) {
        ...
        var textInd = id.indexOf("-") + 1;
        elem.setAttribute("id", id.substr(0, textInd) + encodeText(text));
    };

    var getText = function (elem) {
        var id = elem.getAttribute("id");
        var textInd = id.indexOf("-") + 1;
        return decodeText(id.substr(textInd));
    };
    ...
    */
    ...
    return {
            ...
            if (svgCanvas.getMode() == "qrcode") {
               ...
               */
                ...
                */
                ...
                $(newFO).click(function (e) { e.preventDefault(); });

                var g = S.svgroot.parentNode.ownerDocument.createElementNS(NS.SVG, "g");
                g.id = "";
                newFO.appendChild(g);
        ...
        selectedChanged: function (opts) {
            ...
            if (opts.selectdElement)
                console.log(opts.selectedElement.getAttribute('id').substr(0, 6));
